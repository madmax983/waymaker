...
- **That a reserve formula is safe to tighten across a firmware upgrade.** `Reserve` is
  ...
  [ADR 0053](docs/adr/0053-the-capacity-reserve-formula-is-a-fleet-precondition.md) states
...
[ADR 0053](docs/adr/0053-the-capacity-reserve-formula-is-a-fleet-precondition.md) states that
...
grant today, and both stay owed to rung 0.4's dispatcher or later, per ADR 0053's own
alternatives.
