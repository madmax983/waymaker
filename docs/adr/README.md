...
| [0016](0016-the-storage-contract-is-a-conformance-suite-and-a-port.md) | The storage contract is a conformance suite and a port, both above the layers | accepted |
...
| [0031](0031-a-persistent-clock-is-two-registers-and-the-board-run-is-a-checked-absence.md) | A persistent clock is two registers, and the board run is a checked absence | accepted |
...
| [0041](0041-the-model-gains-banked-records-a-reboot-and-a-live-compaction.md) | The model gains banked records, a reboot, and a live compaction | accepted |
